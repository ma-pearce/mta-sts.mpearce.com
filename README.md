# 🔒 MTA-STS Policy for mpearce.com

This repository hosts the [MTA-STS](https://datatracker.ietf.org/doc/html/rfc8461) (Mail Transfer Agent Strict Transport Security) policy for **mpearce.com**, served via [GitHub Pages](https://pages.github.com/).
...
1. A sending mail server looks up the `_mta-sts.mpearce.com` TXT record to discover that this domain supports MTA-STS
2. It fetches the policy file from `https://mta-sts.mpearce.com/.well-known/mta-sts.txt`
